...
impl TestPlayer {
    ...
    pub async fn new(name: &str, mint_url: String, relay_url: String, deterministic_seed: &str) -> Result<Self> {
        ...
        let mut gaming_wallet = GamingWallet::new(mint_url);
