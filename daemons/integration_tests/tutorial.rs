...
impl TutorialApp {
    pub fn new() -> Self {
        let phases = vec![
            TutorialPhase {
                title: "🚀 PHASE 0: Acquire Mana".to_string(),
                actor: Actor::Alice,
                steps: vec![
                    TutorialStep {
                        ...
                        action: "🏦 Requesting mana tokens with C values...".to_string(),
                        technical_notes: vec![
                    ...
                    TutorialStep {
                        ...
                        action: "🔓 Unblinding mana token to extract C value...".to_string(),
                        technical_notes: vec![
            ...
            TutorialPhase {
                title: "🚀 PHASE 1: Pick an Army".to_string(),
                actor: Actor::Alice,
                steps: vec![
                    TutorialStep {
                        ...
                        action: "⚔️ Generating army from C value randomness...".to_string(),
                        technical_notes: vec![
                            "32 bytes → 4 unit seeds (8 bytes each)".to_string(),
                    ...
                    TutorialStep {
                        ...
                        action: "🔐 Creating SHA256 commitment of army...".to_string(),
                        technical_notes: vec![
            ...
            TutorialPhase {
                title: "🌀 Temporal Suspension".to_string(),
            ...
            TutorialPhase {
                title: "⚔️ PHASE 2: Pick a Fight".to_string(),
                actor: Actor::Bob,
                steps: vec![
                    TutorialStep {
                        ...
                        action: "🏦 Bob acquiring mana and extracting C values...".to_string(),
                        technical_notes: vec![
                    ...
                    TutorialStep {
                        ...
                        action: "⚔️ Bob generating army and creating commitment...".to_string(),
                        technical_notes: vec![
            ...
            TutorialPhase {
                title: "🌀 Temporal Suspension Complete".to_string(),
                actor: Actor::GameEngine,
                steps: vec![
                    TutorialStep {
            ...
            TutorialPhase {
                title: "🔓 PHASE 3: Token Revelation".to_string(),
                actor: Actor::Alice,
                steps: vec![
                    TutorialStep {
                    ...
                    TutorialStep {
                        ...
                        action: "🔍 Verifying tokens and army commitments...".to_string(),
                        technical_notes: vec![
                    ...
                    TutorialStep {
                        ...
                        action: "⚔️ Transitioning to combat phase...".to_string(),
                        technical_notes: vec![
                            "State transition: ACCEPTED → IN_COMBAT".to_string(),
            ...
            TutorialPhase {
                title: "🏆 PHASE 7: Match Result Submission".to_string(),
                actor: Actor::Alice,
                steps: vec![
                    TutorialStep {
                        ...
                        action: "📊 Calculating final match outcome...".to_string(),
                        technical_notes: vec![
                    ...
                    TutorialStep {
                        ...
                        action: "📊 Bob submitting matching result...".to_string(),
                        technical_notes: vec![
            ...
            TutorialPhase {
                title: "✅ PHASE 8: Game Engine Validation".to_string(),
                actor: Actor::GameEngine,
                steps: vec![
                    TutorialStep {
                        ...
                        action: "🔍 Re-executing complete match for validation...".to_string(),
                        technical_notes: vec![
                    ...
                    TutorialStep {
                        ...
                        action: "✅ Verifying outcome matches player calculations...".to_string(),
                        technical_notes: vec![
            ...
            TutorialPhase {
                title: "💰 PHASE 9: Loot Distribution".to_string(),
                actor: Actor::GameEngine,
                steps: vec![
                    TutorialStep {
...
fn draw_explanation(f: &mut Frame, area: Rect, app: &TutorialApp) {
    ...
    let mut explanation_text = vec![
        Line::from(vec![
            Span::styled("📋 Current Action: ", Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD)),
            Span::raw(&step.action),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("📖 Detailed Explanation:", Style::default().fg(Color::Cyan).add_modifier(Modifier::BOLD)),
        ]),
        Line::from(""),
    ];
    ...
    if !step.technical_notes.is_empty() {
        ...
        explanation_text.push(Line::from(vec![
            Span::styled("🔧 Technical Details:", Style::default().fg(Color::Magenta).add_modifier(Modifier::BOLD)),
        ]));
        for note in &step.technical_notes {
            explanation_text.push(Line::from(format!("  • {}", note)));
        }
    }
